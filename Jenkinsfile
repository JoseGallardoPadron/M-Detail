pipeline {
    ...
    environment {
        ...
        PROJECT_KEY = 'JoseGallardoPadron_M-Detail'  // Nombre corregido del proyecto en SonarCloud
        ...
        stage('Clone Repository') {
            steps {
                script {
                    ...
                    git branch: 'main', url: 'https://github.com/JoseGallardoPadron/M-Detail.git'
                }
            }
        }
